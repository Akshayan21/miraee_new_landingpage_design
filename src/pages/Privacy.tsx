    ...
    },
    {
        ...
        body: (
            <>
                ...
                <p style={pStyle}>Email: <a href="mailto:privacy@miraee.ai" style={{ color: T.orange, fontWeight: 600 }}>privacy@miraee.ai</a></p>
