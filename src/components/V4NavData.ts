...
export const V4_NAV = [
    {
        ...
        groups: [
            ...
            },
            {
                ...
                items: [
                    { label: "AI Assistant for Every Employee", to: "/v4/technology#assistant" },
                    { label: "Integrations", to: "/v4/platform#integrations" },
                    { label: "Security & Trust", to: "/v4/technology#governance" },
                    { label: "Implementation / Onboarding", to: "/v4/why-miraee#switching" },
                ],
            },
        ],
    },
    {
        ...
        groups: [
            ...
            },
            {
                heading: "By use case",
                items: [
                    { label: "Business travel", to: "/v4/solutions#use-business" },
                    { label: "Meetings & events", to: "/v4/solutions#use-events" },
                    { label: "Executive travel", to: "/v4/solutions#use-executive" },
                    { label: "Global mobility", to: "/v4/solutions#use-mobility" },
                    { label: "Emergency & disruption", to: "/v4/solutions#use-disruption" },
                ],
            },
        ],
    },
